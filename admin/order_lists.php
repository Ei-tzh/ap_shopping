        ...
        <div class="col-12">
          <div class="card">
            ...
            <?php
                ...
                $stmt=$db->prepare("SELECT * FROM sale_orders ORDER BY id DESC LIMIT $offset,$num_of_rec");
                $stmt->execute();
            ...
            ?>
            <div class="card-body">
              <!-- <a href="" class="btn btn-primary mb-3">New Category</a> -->
                ...
                <?php
                      if($result):
                        ...
                        foreach($result as $value):
                            $userstmt=$db->prepare("SELECT * FROM users WHERE id=".$value['customer_id']);
                            $userstmt->execute();
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a href="order_detail.php?id=<?= escape($value['id']) ?>" class="btn btn-info">View</a>
                            </td>
                          </tr>
                  <?php
                          $i++;
